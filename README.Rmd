...
```{r clusGapDiscrFit, echo=TRUE, eval=TRUE, out.width=215}
## Recall Cats:
# Cats <- setNames(object = c('SD', 'D', 'N', 'A', 'SA'),
#                  nm = c('Strongly Disagree', 'Disagree', 
#                         'Neutral', 
...
```{r resHeatMaps, echo=TRUE, eval=TRUE, out.width=400, dpi=500}
...
```{r resHeatMaps2, echo=TRUE, eval=TRUE, out.width=400, dpi=500, message=FALSE, warning=FALSE, error=FALSE}
