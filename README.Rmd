...
```{r clusGapDiscrFit, echo=TRUE, eval=TRUE, fig.retina=NULL, out.width=210, dpi=500, echo=TRUE, results='hold', fig.show="hold", }
## Recall Cats:
# Cats <- setNames(object = c('SD', 'D', 'N', 'A', 'SA'),
#                  nm = c('Strongly Disagree', 'Disagree', 
#                         'Neutral', 
...
```{r resHeatMaps, echo=TRUE, eval=TRUE, dpi=500, fig.retina=NULL, out.width=230, dpi=500, results='hold', fig.show="hold"}
par(mar=c(3,3,3,0))
