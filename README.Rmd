...
First upload libraries and lightly modify the data. Questions are formatted and the categories are shortened.
...
First we visualize the data using a heatmap similar to the one produced by `likert::likert.heatmap.plot`.
