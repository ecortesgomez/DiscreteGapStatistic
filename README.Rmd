...
```{r clusGapDiscrFit, echo=TRUE, eval=TRUE, out.height = 500, out.width=280, dpi=500, echo=TRUE, results='hold', fig.show="hold"}
## Recall Cats:
# Cats <- setNames(object = c('SD', 'D', 'N', 'A', 'SA'),
#                  nm = c('Strongly Disagree', 'Disagree', 
#                         'Neutral', 
...
```{r resHeatMaps, echo=TRUE, eval=TRUE, out.width=230, dpi=500, results='hold', fig.show="hold"}
