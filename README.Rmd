...
```{r DistanceMats1, out.width=350, dpi=500, echo=TRUE, results='hold', fig.show="hold"}
...
```{r DistanceMats2, out.width=350, dpi=500, echo=TRUE, results='hold', fig.show="hold"}
...
```{r clusGapDiscrFit, echo=TRUE, eval=TRUE, out.height = 500, out.width=300, dpi=500, echo=TRUE, results='hold', fig.show="hold"}
## Recall Cats:
# Cats <- setNames(object = c('SD', 'D', 'N', 'A', 'SA'),
#                  nm = c('Strongly Disagree', 'Disagree', 
#                         'Neutral', 
...
```{r resHeatMaps, echo=TRUE, eval=TRUE, out.height = 500, out.width=300, dpi=500, results='hold', fig.show="hold"}
...
```{r resHeatMaps2, echo=TRUE, eval=TRUE, out.height = 500, out.width=300, dpi=500, results='hold', fig.show="hold", message=FALSE, warning=FALSE, error=FALSE}
